# Generated by Django 3.2 on 2023-04-14 05:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.TextField(blank=True, verbose_name='内容')),
                ('description', models.TextField(blank=True, verbose_name='参考文献・過去積算案件')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('upload', models.FileField(upload_to=snippets.models.get_upload_path)),
                ('uped_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snippets.snippet', verbose_name='ポイント')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('commented_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snippets.snippet', verbose_name='ポイント')),
            ],
        ),
    ]
