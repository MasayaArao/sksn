...
SECRET_KEY = 'django-insecure-5@+20jz0x=!2d+=v@nk(-*3=)zew6^v_5mg43-a1i=+mthmom_'
...
INSTALLED_APPS = [
    ...
    'django.contrib.contenttypes',#Content-Typeに関する機能をもつ
    'django.contrib.sessions',#セッション管理の機能
    'django.contrib.messages',#フラッシュメッセージ
    'django.contrib.staticfiles',#CSSやJavaScriptなどに関連する機能
